		...
		uint8_t SquelchOpenGlitchThresh)
{
	...
	//         0 ~ 255
	//
	// quansheng_alert: the delays are user settings (stock effective values
	// were open 5 / close 2 - the original wrote 6<<9, which spills into bit 11).
	// 0 = fastest. Short ALERT data bursts need the squelch to open quickly.
