...
//   text,     voice ID,                               menu ID
	...
	{"SqOpen", VOICE_ID_INVALID,                       MENU_SQ_OPEN       }, // quansheng_alert
	{"SqClos", VOICE_ID_INVALID,                       MENU_SQ_CLOSE      }, // quansheng_alert
#ifdef ENABLE_ALERT
	{"AlrtRx", VOICE_ID_INVALID,                       MENU_ALERT         }, // quansheng_alert
#endif
...
//			UI_PrintStringSmallNormal(String, 0, 0, 0);
	...
	{
		case MENU_SQL:
			sprintf(String, "%d.%d", (int)(gSubMenuSelection / 10), (int)(gSubMenuSelection % 10));
			break;

		case MENU_SQ_OPEN:
		case MENU_SQ_CLOSE:
			sprintf(String, "%d%s", (int)gSubMenuSelection, gSubMenuSelection == 0 ? "\nFASTEST" : "");
			break;
