...
void MENU_AcceptSetting(void)
{
	...
	switch (UI_MENU_GetCurrentMenuId())
	{
		...
		case MENU_SQL:
			gEeprom.SQUELCH_LEVEL  = gSubMenuSelection / 10;
			gEeprom.SQUELCH_TENTHS = gSubMenuSelection % 10;
			gVfoConfigureMode      = VFO_CONFIGURE;
			break;

		case MENU_SQ_OPEN:
			gEeprom.SQL_OPEN_DELAY = gSubMenuSelection;
			gVfoConfigureMode      = VFO_CONFIGURE;
			break;

		case MENU_SQ_CLOSE:
			gEeprom.SQL_CLOSE_DELAY = gSubMenuSelection;
			gVfoConfigureMode       = VFO_CONFIGURE;
			break;
...
void MENU_ShowCurrentSetting(void)
{
	...
	{
		case MENU_SQL:
			gSubMenuSelection = gEeprom.SQUELCH_LEVEL * 10 + gEeprom.SQUELCH_TENTHS;
			break;

		case MENU_SQ_OPEN:
			gSubMenuSelection = gEeprom.SQL_OPEN_DELAY;
			break;

		case MENU_SQ_CLOSE:
			gSubMenuSelection = gEeprom.SQL_CLOSE_DELAY;
			break;
